...
export function SubComponent(annotation: any) {
  ...
  //let metadata = Object.create(DecoratorFactory);
  //metadata = Object.assign(metadata, defaultComponentProps, annotation);
  //Object.setPrototypeOf(annotation, DecoratorFactory);
