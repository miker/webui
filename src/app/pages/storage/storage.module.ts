...
import { MaterialModule, MatTableModule, MatCardModule, MatGridListModule } from '@angular/material';
...
@NgModule({
  imports : [
    ...
    ReactiveFormsModule, routing, MaterialModule, MatTableModule, MatCardModule, MatGridListModule,
